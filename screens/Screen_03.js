...
export default function App({navigation}) {
    const [data, setData] = useState([
        {key: '1', type: 'Vegetable', name: 'Apple', price: '28.00', image: require('../assets/Image101.png'), sl: 1},
        {key: '1', type: 'Vegetable', name: 'Pear', price: '28.00', image: require('../assets/Image102(1).png'), sl: 2},
        {key: '1', type: 'Vegetable', name: 'Coconut', price: '28.00', image: require('../assets/Image103.png'), sl: 3},
        {key: '1', type: 'Vegetable', name: 'Pear', price: '28.00', image: require('../assets/Image105.png'), sl: 1},
        {key: '1', type: 'Vegetable', name: 'Coconut', price: '28.00', image: require('../assets/Image106(1).png'), sl: 2},
        {key: '1', type: 'Vegetable', name: 'Coconut', price: '28.00', image: require('../assets/Image107.png'), sl: 3},
        {key: '1', type: 'Vegetable', name: 'Pear', price: '28.00', image: require('../assets/Image105.png'), sl: 1},
        ...
        {key: '1', type: 'Drink', name: 'Drink 1', price: '28.00', image: require('../assets/Image_96.png')},
        {key: '1', type: 'Drink', name: 'Drink 2', price: '28.00', image: require('../assets/Image_96.png')},
        {key: '1', type: 'Drink', name: 'Drink 3', price: '28.00', image: require('../assets/Image_96.png')},
        {key: '1', type: 'Drink', name: 'Drink 4', price: '28.00', image: require('../assets/Image_96.png')},
        {key: '1', type: 'Drink', name: 'Drink 5', price: '28.00', image: require('../assets/Image_96.png')},
        {key: '1', type: 'Drink', name: 'Drink 6', price: '28.00', image: require('../assets/Image_96.png')},
    ]);
                    ...
                    renderItem={({item}) => (
                        <View style={{
                            ...
                            <View style={{marginLeft: 140, flexDirection: 'row', alignItems: 'center'}}>
                                <Image 
                                    source={require('../assets/Image176.png')}
                                    style={{width: 15, height: 15, marginRight: 10}}
                                />
                                <Text style={{fontSize: 15}}>{item.sl}</Text>
                                <Image 
                                    source={require('../assets/Image175.png')}
                                    style={{width: 15, height: 15, marginRight: 10}}
                                />
                            </View>
                        </View>
